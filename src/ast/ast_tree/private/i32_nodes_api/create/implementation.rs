...
use crate::{
    ast::ast_tree::{
        ...
        private::i32_nodes_api::{
            entity::{new_with_value::I32AstNodeInternalApiNewWithValue, I32AstEntity},
            storage::I32NodesApi,
        },
    },
...
use super::I32AstTreeApiPut;

impl I32AstTreeApiPut for I32NodesApi {
    fn create(&mut self, i32_value: i32) -> Result<Uuid, ParseError> {
        let new_node = I32AstEntity::new_with_value(i32_value).unwrap_or_else(|e| {
            panic!(
        ...
        match self.tree.insert(new_node_id, new_node) {
            None => Ok(new_node_id),
